...
function(t, i) {
	...
	return g._create = function() {
		...
		this.disable(), this.element.style[p] = "", this.element.style.left = "100%", this.element.style.top = "", this.element.style.position = "", this.unbindHandles(), this.$element && this.$element.removeData("draggabilly")
